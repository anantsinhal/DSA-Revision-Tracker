      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            {/* Tags — managed with useState, not react-hook-form */}
            <div className="space-y-2">
              ...
              <div className="flex gap-2 mb-2">
                <Input
                  ...
                  placeholder="e.g. DP, Graph (Press Enter)"
                  data-testid="input-tag"
                />
                <Button type="button" variant="secondary" onClick={handleAddTag} data-testid="button-add-tag">
                    ...
                    <FormItem>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className={`text-sm font-medium px-2 py-0.5 rounded ${
                          field.value <= 2 ? "bg-red-500/10 text-red-500" :
                          field.value === 3 ? "bg-amber-500/10 text-amber-500" :
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="date" {...field} data-testid="input-last-revised" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="number" placeholder="Auto based on conf." {...field} data-testid="input-revision-frequency" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
          ...
          <div className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Briefly describe the optimal approach..."
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="O(N)" className="font-mono" {...field} data-testid="input-time-complexity" />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="O(1)" className="font-mono" {...field} data-testid="input-space-complexity" />
                    </FormControl>
                  </FormItem>
                )}
              />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-amber-500 dark:text-amber-400">Mistakes & Gotchas</FormLabel>
                  <FormControl>
                    <Textarea
                      placeholder="What did you mess up last time? Edge cases missed?"
                      className="h-32 border-amber-500/30 focus-visible:ring-amber-500"
                      {...field}
                      data-testid="textarea-mistake-notes"
                    />
                  </FormControl>
                </FormItem>
              )}
